...
OUTPUT_PREFIX="C087_centromere_hap2"     # Prefix for output files
THREADS=32                           # Number of threads to use

# Run CentroMiner
python -m  quartet CentroMiner -i $GENOME/C087_203_mapq_hap2_8.fa -t $THREADS -p $OUTPUT_PREFIX --overwrite
